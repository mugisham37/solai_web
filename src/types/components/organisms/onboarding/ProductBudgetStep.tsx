...
import { updateProductBudgetAction } from "@/lib/actions/onboarding";
...
interface ProductBudgetStepProps {
  draft: OnboardingDraft;
}

export function ProductBudgetStep({ draft: initialDraft }: ProductBudgetStepProps) {
  ...
  async function handleContinue() {
    ...
    setErrors({});
    await updateProductBudgetAction(
      {
